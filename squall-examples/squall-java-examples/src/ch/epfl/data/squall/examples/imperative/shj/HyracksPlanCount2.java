...
public class HyracksPlanCount2 extends QueryPlan {

    public HyracksPlanCount2(String dataPath, String extension, Map conf) {
    ...
    public Component createQueryPlan(String dataPath, String extension, Map conf) {
        ...
        Component orders = new DataSourceComponent("orders", conf)
							...
							.add(new ApproximateCountSamplingOperator(conf,1500000).setGroupByColumns(1));
